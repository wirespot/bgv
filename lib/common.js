...
Object.prototype.combine = function (other) {
    ...
    for (var thisProp in this) {
        if (!this.hasOwnProperty(thisProp)) continue;
        obj[thisProp] = this[thisProp];
    }
    for (var otherProp in other) {
        if (!other.hasOwnProperty(otherProp)) continue;
        obj[otherProp] = other[otherProp];
    }
    return obj;
};
