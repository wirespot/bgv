...
var Correctors = {
    correctors: {
        ...
        seat_angle: [{
            ...
            f: function () {
                return Util.radToDeg(
                    Util.triangleAngleBySides(
                        this.Def.chainstay, this.Def.seat_tube, this.Def.frame_ste_rear
                    )
                    + Math.asin(this.Def.bb_drop / this.Def.chainstay)
                );
            }
        }],
        top_tube_length: [{
