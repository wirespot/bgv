var Calculators = {
    ...
    calculators: {
        ...
        center: [{
            ...
            f: function () {
                return Util.diff(this.values.bottomBracket[0], this.values.bottomBracket[1],
        ...
        rearContactPatch: [{
            ...
            f: function () {
                return [
                    ...
                    this.values.rearWheelHub[1] + this.Def.wheel + this.Def.tire
                ];
            }
        }],
        forkStraight: [{
        ...
        frontContactPatch: [{
            ...
            f: function () {
                return [
                    ...
                    this.values.frontWheelHub[1] + this.Def.wheel + this.Def.tire
                ];
            }
        }]
    }
