...
var Renderers = {
    ...
    renderers: {
        gravitySpot: [{
            ...
            f: function () {
                Draw.disc(this.values.gravitySpot[0], this.values.gravitySpot[1], Util.factor(Settings.bb_radius));
            }
        }],
        centerSpot: [{
            dependencies: [
            ...
            f: function () {
                Draw.disc(this.values.centerSpot[0], this.values.centerSpot[1], Util.factor(Settings.bb_radius));
console.log(this.values.centerSpot);
            }
        }],
        bottomBracket: [{
            dependencies: [
