...
var Renderers = {
    ...
    renderers: {
        ...
        ttl: [{
            ...
            f: function () {
                Draw.line(this.values.bottomBracket, this.values.ttlSpot);
                Draw.line(this.values.headTop, this.values.ttlSpot);
            }
        }],
        stack: [{
            dependencies: [
            ...
            f: function () {
                Draw.line(this.values.bottomBracket,
