...
var Renderers = {
    ...
    renderers: {
        ...
        seatTube: [{
            ...
            f: function () {
                Draw.rectXY(
                    ...
                    Util.zoomApply(this.Def['seat_size']
                        ? this.Def.seat_size : Settings.fallback_size)
                );
            }
        }],
        bottomBracket: [{
        ...
        ttl: [{
            ...
            f: function () {
                Draw.dashedLine(this.values.seatTubeEnd, this.values.ttlSpot);
                Draw.dashedLine(this.values.ttlSpot,
            ...
            f: function () {
                Draw.rectXY(
                    ...
                    Util.zoomApply(this.Def['head_size']
                        ? this.Def.head_size : Settings.fallback_size)
                );
            }
        }
        ],
        ...
        chainstay: [{
            ...
            f: function () {
                Draw.rectXY(
                    this.values.bottomBracket,
                    this.values.rearWheelHub,
                    Util.zoomApply(Settings.fallback_size)
                );
            }
        }],
        rearWheel: [{
        ...
        wheelBase: [{
            ...
            f: function () {
                Draw.dashedLine(this.values.rearContactPatch, this.values.frontContactPatch);
                Draw.dashedLine(this.values.rearContactPatch,
                    Util.findPoint(this.values.rearContactPatch,
                        Util.zoomApply(this.Def.wheel / 2 + this.Def.tire)
                        , Util.degToRad(270)));
            }
        }],
