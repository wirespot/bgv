...
var Util = {
    ...
    /**
     * Translate a point's coordinates from the "absolute" canvas coordinate
     * system to a "relative" system using as origin another point (also given
     * in canvas system).
     * @param absPoint The point, with canvas coordinates.
     * @param refAbsPoint The reference point, also with canvas coordinates.
     * @returns {Array} A point whose coordinates are relative to the reference.
     */
    relativePoint: function (absPoint, refAbsPoint) {
        return [absPoint[0] - refAbsPoint[0], absPoint[1] - refAbsPoint[1]];
    }
};
