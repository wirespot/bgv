...
var Labels = {
    ...
    labels: {
        top_tube_length: [{
            ...
            f: function () {
                Draw.label('TOP TUBE LENGTH ' + this.Def.top_tube_length + 'mm',
        ...
        stack: [{
            ...
            f: function () {
                Draw.label('STACK ' + this.Def.stack + 'mm',
        ...
        reach: [{
            ...
            f: function () {
                Draw.label('REACH ' + this.Def.reach + 'mm',
                    this.values.bottomBracket[0] + Settings.labels_pad_vertical,
        ...
        fork_offset: [{
            ...
            f: function () {
                Draw.label('OFFSET ' + this.Def.fork_offset + 'mm',
        ...
        fork_trail: [{
            ...
            f: function () {
                Draw.label('TRAIL ' + this.Def.fork_trail + 'mm',
        ...
        wheel_base: [{
            ...
            f: function () {
                Draw.label('WHEEL BASE ' + this.Def.wheel_base + 'mm',
