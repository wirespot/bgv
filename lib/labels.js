    ...
    labels: {
        ...
        fork_length: [{
            ...
            f: function () {
                ...
                Draw.label('FORK ' + Util.toInt(this.Def.fork_length) + 'mm',
        ...
        head_tube: [{
            ...
            f: function () {
                var padding = Settings.labels_pad_vertical
                    + (typeof(this.Def.head_size) != 'undefined'
                    ? Util.zoomApply(this.Def.head_size) / 2
                    : Settings.labels_pad_horizontal);
                var point = Util.findPoint(this.values.headTop,
                    padding, Util.degToRad(this.Def.head_angle - 90)
                );
            ...
            f: function () {
                var delta = Settings.labels_font_size
                    + (typeof(this.Def.head_size) != 'undefined'
                        ...
                        : Settings.labels_pad_horizontal);
                var point = Util.findPoint(this.values.headTop,
                    delta, Util.degToRad(this.Def.head_angle + 90)
                );
                Draw.label(
                    String.fromCharCode(8738) + ' '
