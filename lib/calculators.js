        ...
        steererTop: [{
            ...
            f: function () {
                return Util.afar(
                    ...
                    Util.zoomApply(this.Def.fork_steerer), Util.degToRad(this.Def.head_angle - 180)
                );
            }
        }],
        rearWheelHub: [{
        ...
        frontWheelHubOffset: [{
            ...
            f: function () {
                return Util.afar(this.values.headBottom[0], this.values.headBottom[1],
                    this.values.forkStraight, Util.degToRad(this.Def.head_angle)
                );
            }
            }, {
            dependencies: [
            ...
            f: function () {
                return Util.afar(this.values.frontWheelHub[0], this.values.frontWheelHub[1],
                    Util.zoomApply(this.Def.fork_offset), Util.degToRad(this.Def.head_angle + 90)
                );
            }
        }],
        frontWheelHub: [{
