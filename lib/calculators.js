    ...
    calculators: {
        ...
        headTop: [{
            ...
            f: function () {
                ...
                var circleCenter = this.values.frontWheelHub;
                ...
                var R = Util.zoomApply(Math.sqrt(
                    Math.pow(this.Def.fork_offset, 2)
                    + Math.pow(this.Def.fork_straight + this.Def.head_tube, 2)
                ));
        ...
        rearWheelHub: [{
            ...
            f: function () {
                return [
                    this.values.frontWheelHub[0] - Util.zoomApply(this.Def.wheel_base),
